...
// TEST_REGISTER(stvec_test_4);
// TEST_REGISTER(stvec_test_5);
// TEST_REGISTER(vstvec_test_1);
// TEST_REGISTER(vstvec_test_2);
// TEST_REGISTER(vstvec_test_3);
// TEST_REGISTER(vstvec_test_4);
// TEST_REGISTER(vstvec_test_5);
// TEST_REGISTER(vstvec_test_6);
// TEST_REGISTER(m_double_trap_1);
// TEST_REGISTER(m_double_trap_2);
// TEST_REGISTER(m_double_trap_3);
// TEST_REGISTER(m_double_trap_4);
// TEST_REGISTER(m_double_trap_5);
// TEST_REGISTER(m_double_trap_6);      //要修改.S文件
// TEST_REGISTER(m_double_trap_7);
// TEST_REGISTER(m_double_trap_8);      //要修改.S文件
// TEST_REGISTER(m_double_trap_9);
...
// TEST_REGISTER(m_double_trap_18);
// TEST_REGISTER(m_double_trap_19);
// TEST_REGISTER(m_double_trap_20);
// TEST_REGISTER(m_double_trap_21);
// TEST_REGISTER(s_double_trap_1);
// TEST_REGISTER(s_double_trap_2);
// TEST_REGISTER(s_double_trap_3);
// TEST_REGISTER(s_double_trap_4);
// TEST_REGISTER(s_double_trap_5);
// TEST_REGISTER(s_double_trap_66);
...
// TEST_REGISTER(s_double_trap_17);
// TEST_REGISTER(s_double_trap_18);
// TEST_REGISTER(s_double_trap_19);
// TEST_REGISTER(s_double_trap_20);
// TEST_REGISTER(hs_double_trap_1);
